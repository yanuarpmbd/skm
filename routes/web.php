...
Route::group(['prefix' => 'admin'], function () {
    Voyager::routes();
    //Custom
    Route::get('rekap-bulanan', ['uses'=>'RekapBulananController@index', 'as'=>'rekapbulanan.data']);
    //Route::get('/rekap-bulanan','RekapBulananController@index')->name('get-rekap-bulanan');
});
